...
public class AbstractComplexMatrixTest {
  ...
  public void testAssign() throws Exception {
    ComplexMatrix m = bj.complexMatrix(3, 3);
    m.assign(3);
  ...
  public void testAssign3() throws Exception {
    ...
    ComplexMatrix i = bj.complexMatrix(3, 3).assign(d, Complex::valueOf);
  ...
  public void testAssign6() throws Exception {
    ComplexMatrix i = bj.complexMatrix(3, 3).assign(bj.complexMatrix(3, 3).assign(3));
    assertMatrixEquals(3, i);
  }
  ...
  public void testAssign7() throws Exception {
    ComplexMatrix i =
        bj.complexMatrix(3, 3).assign(bj.complexMatrix(3, 3).assign(3), x -> x.multiply(2));
    assertMatrixEquals(6, i);
  }

  @Test
  public void testAssign8() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(2);
    ComplexMatrix d = bj.complexMatrix(3, 3).assign(5);
  ...
  public void testMap() throws Exception {
    ComplexMatrix i = bj.complexMatrix(3, 3).assign(3);
  ...
  public void testMapToInt() throws Exception {
    ComplexMatrix i = bj.complexMatrix(3, 3).assign(10);
  ...
  public void testMapToDouble() throws Exception {
    DoubleMatrix i =
        bj.complexMatrix(3, 3).assign(3).mapToDouble((complex) -> complex.sqrt().real());
    assertMatrixEquals(Math.sqrt(3), i, 0.0001);
  }

  public void testMapToLong() throws Exception {
    LongMatrix i = bj.complexMatrix(3, 3).assign(-3).mapToLong(x -> (long) x.real());
    assertMatrixEquals(i, -3);
  }

  @Test
  public void testFilter() throws Exception {
    ComplexMatrix i = bj.complexMatrix(new double[]{0, 1, 2, 3, 4, 5, 6}).filter(x -> x.real() > 3);
    assertValuesEquals(bj.complexMatrix(new double[]{4, 5, 6}), i);
  }

  @Test
  public void testSatisfies() throws Exception {
    BitMatrix i = bj.complexMatrix(new double[]{0, 1, 2, 3, 4, 5}).satisfies(x -> x.real() >= 3);
  ...
  public void testReduce() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(3);
  ...
  public void testReduceColumns() throws Exception {
    ComplexMatrix x =
        bj.complexMatrix(3, 4).assign(3).reduceColumns(y -> y.reduce(Complex.ZERO, Complex::plus));
  ...
  public void testReduceRows() throws Exception {
    ComplexMatrix x =
        bj.complexMatrix(4, 3).assign(3).reduceRows(y -> y.reduce(Complex.ZERO, Complex::plus));
  ...
  public void testReshape() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 2, 3, 4, 5, 6}).reshape(2, 3);
  ...
  public void testGet() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{0, 1, 2, 3, 4, 5}).reshape(3, 2);
  ...
  public void testSet1() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{0, 1, 2, 3});
    assertEquals(Complex.valueOf(0), x.get(0));
  ...
  public void testGetView() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 1, 1, 1, 2, 2}).reshape(2, 3);
    assertMatrixEquals(1, x.getView(0, 0, 2, 2));
  }

  @Test
  public void testTranspose() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 2, 3, 1, 2, 3}).reshape(2, 3).transpose();
  ...
  public void testCopy() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 1, 1, 1});
  ...
  public void testMmul() throws Exception {
    ...
    ComplexMatrix y = bj.complexMatrix(new double[]{1, 2, 3, 4, 5, 6}).reshape(2, 3);

    ComplexMatrix z = y.mmul(x);
    ComplexMatrix za = bj.complexMatrix(new double[]{22, 28, 49, 64}).reshape(2, 2);
    assertMatrixEquals(z, za);

    z = x.mmul(y);
    za = bj.complexMatrix(new double[]{9, 12, 15, 19, 26, 33, 29, 40, 51}).reshape(3, 3);
    assertMatrixEquals(z, za);
  }
  ...
  public void testMmul1() throws Exception {
    ...
    ComplexMatrix za = bj.complexMatrix(new double[]{44, 56, 98, 128}).reshape(2, 2);
    assertMatrixEquals(z, za);

    z = x.mmul(Complex.valueOf(4), y);
    za = bj.complexMatrix(new double[]{36, 48, 60, 76, 104, 132, 116, 160, 204}).reshape(3, 3);
    assertMatrixEquals(z, za);
  }
  ...
  public void testMul1() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(3);
    ComplexMatrix y = bj.complexMatrix(3, 3).assign(2);
  ...
  public void testDiv() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(4);
  ...
  public void testRdiv() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(6);
  ...
  public void testNegate() throws Exception {
    ComplexMatrix x = bj.complexMatrix(3, 3).assign(3).negate();
    assertMatrixEquals(x, Complex.valueOf(3).negate());
  }

  @Test
  public void testSlice1() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 2, 3, 1, 2, 3}).reshape(3, 2);
    ComplexMatrix slice = x.slice(bj.range(3));
    assertValuesEquals(bj.complexMatrix(new double[]{1, 2, 3}), slice);
  }
  ...
  public void testSlice4() throws Exception {
    ...
    assertValuesEquals(bj.complexMatrix(new double[]{1, 3, 3, 2}), s);
  }
  ...
  public void testSwap() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 2, 3});
    x.swap(0, 2);
    assertValuesEquals(bj.complexMatrix(new double[]{3, 2, 1}), x);
  }
  ...
  public void testIterator() throws Exception {
    ComplexMatrix x = bj.complexMatrix(new double[]{1, 2, 3, 4, 5, 6});
    int i = 0;
    for (Complex v : x) {
  ...
  public void testStream() throws Exception {
    ComplexMatrix m = bj.complexMatrix(3, 3).assign(3);

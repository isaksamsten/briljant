...
public class ArrayComplexMatrix extends AbstractComplexMatrix {
  ...
  public ArrayComplexMatrix(ComplexMatrix other) {
  ...
  public ArrayComplexMatrix(Matrix matrix) {
  ...
  public ArrayComplexMatrix(int rows, int cols, Collection<? extends Complex> values) {
    this(rows, cols);
  ...
  protected ArrayComplexMatrix(int rows, int cols, double[] values) {
    super(rows, cols);
    this.values = values;
  }

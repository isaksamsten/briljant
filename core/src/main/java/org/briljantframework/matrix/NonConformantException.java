...
public class NonConformantException extends RuntimeException {
     ...
     * @param op2    the op 2
     */
    public NonConformantException(String param1, MatrixLike op1, String param2, MatrixLike op2) {
     ...
     * @param op2 the op 2
     */
    public NonConformantException(MatrixLike op1, MatrixLike op2) {
    ...
    public NonConformantException(String op1, int am, int an, String op2, int bm, int bn) {
        super(String.format("nonconformant arguments (%s is %dx%d, %s is %dx%d)", op1, am, an, op2, bm, bn));
    }

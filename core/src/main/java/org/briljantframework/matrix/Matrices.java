...
public class Matrices {
    ...
    /**
     * Multiplying a square matrix X with a symmetric diagonal matrix (i.e. a vector of diagonal entries) d storing the
     * result in Y.
     * <p>
    ...
    /**
     * Find elements in {@code matrix} for which the corresponding value in {@code booleanMatrix} is true. Return a new
     * Vector.
     *
     * @param <Out>         the type parameter
    ...
    /**
     * Take the inner product of two vectors (m x 1) and (1 x m) scaling them by alpha and beta respectively
     *
    ...
    /**
     * Add vector a and b, scaling by alpha and beta storing the result in c. I.e. c <- alpha*a + beta*b
     * <p>
     * <pre>

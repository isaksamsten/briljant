...
public class Lapack {
    ...
    static {
        try {
            /*
                On one hand, the integrated Lapack-library included in OpenBLAS is for the windows and mac platform.
                On the other hand, a separate lapack (liblapack) and BLAS libraries are used on other unixes (e.g.,
                Debian).
     ...
     * @return the int
     */
    public static native int LAPACKE_dgetrf(int matrix_order, int m, int n,
     ...
     * @return the int
     */
    public static native int LAPACKE_dgetri(int matrix_order, int n, double[] a,
                                            int lda, int[] ipiv);
     ...
     * @return the int
     */
    public static native int LAPACKE_dgelsy(int matrix_order, int m, int n,
                                            int nrhs, double[] a, int lda,
                                            double[] b, int ldb, int[] jpvt,
                                            double rcond, IntByReference rank);
}

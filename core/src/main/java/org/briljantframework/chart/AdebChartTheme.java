...
public final class AdebChartTheme extends StandardChartTheme {
  ...
  public AdebChartTheme(String name, boolean shadow) {
    ...
    colors =
        new Paint[] {new Color(0, 55, 255, 180), new Color(255, 172, 0, 180),
            new Color(128, 0, 255, 180), new Color(0, 205, 0, 180), new Color(205, 0, 0, 180),
            new Color(255, 215, 0, 180), new Color(255, 0, 255, 180),
            new Color(255, 166, 201, 180), new Color(207, 207, 207, 180),
            new Color(0, 255, 255, 180), new Color(102, 56, 10, 180), new Color(0, 0, 0, 180)};

    setShadowVisible(false);
    setDrawingSupplier(new DefaultDrawingSupplier(colors, colors, new Stroke[] {new BasicStroke(
        1.0f)}, new Stroke[] {new BasicStroke(0.5f)}, DefaultDrawingSupplier.DEFAULT_SHAPE_SEQUENCE));
  }

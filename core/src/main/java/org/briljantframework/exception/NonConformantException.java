...
public class NonConformantException extends RuntimeException {
   ...
   * @param op2 the op 2
   */
  public NonConformantException(String param1, RealMatrixLike op1, String param2, RealMatrixLike op2) {
   ...
   * @param op2 the op 2
   */
  public NonConformantException(RealMatrixLike op1, RealMatrixLike op2) {

...
public class DataSeriesNormalizationTest {
  ...
  public void testFit() throws Exception {
    ...
    System.out.println("Approx distance 0 3: " + distance.distance(saxs.getRow(0), saxs.getRow(3)));
    ...
    start = System.currentTimeMillis();
    System.out.println("Approx distance 0 5: " + distance.distance(saxs.getRow(0), saxs.getRow(5)));

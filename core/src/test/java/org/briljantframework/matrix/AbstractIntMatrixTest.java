...
public class AbstractIntMatrixTest {
  ...
  public void testFilter() throws Exception {
    ...
    assertValuesEquals(newIntVector(4, 5, 6), i);
  }
  ...
  public void testAdd3() throws Exception {
    ...
    assertValuesEquals(newIntVector(4, 5, 6), z.getRowView(0));
    assertValuesEquals(newIntVector(4, 5, 6), z.getRowView(1));
    assertValuesEquals(newIntVector(4, 5, 6), z.getRowView(2));

    z = y.add(x, Axis.COLUMN);
    assertValuesEquals(newIntVector(4, 5, 6), z.getColumnView(0));
    assertValuesEquals(newIntVector(4, 5, 6), z.getColumnView(1));
    assertValuesEquals(newIntVector(4, 5, 6), z.getColumnView(2));
  }
  ...
  public void testAdd4() throws Exception {
    ...
    assertValuesEquals(newIntVector(2, 1, 0), z.getRowView(0));
    assertValuesEquals(newIntVector(2, 1, 0), z.getRowView(1));
    assertValuesEquals(newIntVector(2, 1, 0), z.getRowView(2));

    z = y.add(1, x, -1, Axis.COLUMN);
    assertValuesEquals(newIntVector(2, 1, 0), z.getColumnView(0));
    assertValuesEquals(newIntVector(2, 1, 0), z.getColumnView(1));
    assertValuesEquals(newIntVector(2, 1, 0), z.getColumnView(2));
  }
  ...
  public void testDiv2() throws Exception {
    ...
    assertValuesEquals(newIntVector(6, 3, 2), z.getRowView(0));
    assertValuesEquals(newIntVector(6, 3, 2), z.getRowView(1));
    assertValuesEquals(newIntVector(6, 3, 2), z.getRowView(2));

    z = y.div(x, Axis.COLUMN);
    assertValuesEquals(newIntVector(6, 3, 2), z.getColumnView(0));
    assertValuesEquals(newIntVector(6, 3, 2), z.getColumnView(1));
    assertValuesEquals(newIntVector(6, 3, 2), z.getColumnView(2));
  }
  ...
  public void testDiv3() throws Exception {
    ...
    assertValuesEquals(newIntVector(12, 6, 4), z.getRowView(0));
    assertValuesEquals(newIntVector(12, 6, 4), z.getRowView(1));
    assertValuesEquals(newIntVector(12, 6, 4), z.getRowView(2));

    z = y.div(2, x, 1, Axis.COLUMN);
    assertValuesEquals(newIntVector(12, 6, 4), z.getColumnView(0));
    assertValuesEquals(newIntVector(12, 6, 4), z.getColumnView(1));
    assertValuesEquals(newIntVector(12, 6, 4), z.getColumnView(2));
  }
  ...
  public void testSlice1() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 2, 3), slice);
  }
  ...
  public void testSlice2() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 1, 1), slice.getRowView(0));
    assertValuesEquals(newIntVector(2, 2, 2), slice.getRowView(1));
  }
  ...
  public void testSlice3() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 1), s.getRowView(0));
    assertValuesEquals(newIntVector(2, 2), s.getRowView(1));
  }
  ...
  public void testSlice4() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 3, 3, 2), s);
  }
  ...
  public void testSlice5() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 1, 1), s.getRowView(0));
    assertValuesEquals(newIntVector(3, 3, 3), s.getRowView(1));
  }
  ...
  public void testSlice7() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 2, 3), s);
  }
  ...
  public void testSwap() throws Exception {
    IntMatrix x = newIntVector(1, 2, 3);
    x.swap(0, 2);
    assertValuesEquals(newIntVector(3, 2, 1), x);
  }
  ...
  public void testSetRow() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 2, 3), x.getRowView(0));
  }
  ...
  public void testSetColumn() throws Exception {
    ...
    assertValuesEquals(newIntVector(1, 2, 3), x.getColumnView(0));
  }
  ...
  public void testStream() throws Exception {
    IntMatrix m = newIntMatrix(3, 3).assign(3);

...
public class AbstractLongMatrixTest {
  ...
  public void testRsub2() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(3);
    LongMatrix z = y.rsub(x, Axis.ROW);
    MatrixAssert.assertValuesEquals(z.getRowView(0), LongMatrix.of(-2, -1, 0));
    MatrixAssert.assertValuesEquals(z.getRowView(1), LongMatrix.of(-2, -1, 0));
    MatrixAssert.assertValuesEquals(z.getRowView(2), LongMatrix.of(-2, -1, 0));

    z = y.rsub(x, Axis.COLUMN);
    MatrixAssert.assertValuesEquals(z.getColumnView(0), LongMatrix.of(-2, -1, 0));
    MatrixAssert.assertValuesEquals(z.getColumnView(1), LongMatrix.of(-2, -1, 0));
    MatrixAssert.assertValuesEquals(z.getColumnView(2), LongMatrix.of(-2, -1, 0));
  }

  @Test
  public void testAssign() throws Exception {
    LongMatrix m = LongMatrix.newMatrix(3, 3);
    m.assign(3);
  ...
  public void testAssign3() throws Exception {
    ...
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(d, x -> (int) x);
  ...
  public void testAssign4() throws Exception {
    ...
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(c, Complex::intValue);
    assertMatrixEquals(i, 3);
  }
  ...
  public void testAssign5() throws Exception {
    ...
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(l, x -> (int) x);
    assertMatrixEquals(i, 3);
  }

  @Test
  public void testAssign6() throws Exception {
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(LongMatrix.newMatrix(3, 3).assign(3));
    assertMatrixEquals(i, 3);
  }

  @Test
  public void testAssign7() throws Exception {
    LongMatrix i = LongMatrix
        .newMatrix(3, 3).assign(LongMatrix.newMatrix(3, 3).assign(3), x -> x * 2);
    assertMatrixEquals(i, 6);
  }

  @Test
  public void testAssign8() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(2);
    LongMatrix d = LongMatrix.newMatrix(3, 3).assign(5);
    x.assign(d, Long::sum);
  ...
  public void testMap() throws Exception {
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(3);
  ...
  public void testMapToInt() throws Exception {
    LongMatrix i = LongMatrix.newMatrix(3, 3).assign(Integer.MAX_VALUE + 10L);
  ...
  public void testMapToDouble() throws Exception {
    DoubleMatrix i = LongMatrix.newMatrix(3, 3).assign(3).mapToDouble(Math::sqrt);
    assertMatrixEquals(Math.sqrt(3), i, 0.0001);
  }

  @Test
  public void testMapToComplex() throws Exception {
    ComplexMatrix i = LongMatrix.newMatrix(3, 3).assign(-3).mapToComplex(Complex::sqrt);
    assertMatrixEquals(i, Complex.sqrt(-3));
  }

  @Test
  public void testFilter() throws Exception {
    LongMatrix i = LongMatrix.of(0, 1, 2, 3, 4, 5, 6).filter(x -> x > 3);
    MatrixAssert.assertValuesEquals(i, LongMatrix.of(4, 5, 6));
  }

  @Test
  public void testSatisfies() throws Exception {
    BitMatrix i = LongMatrix.of(0, 1, 2, 3, 4, 5).satisfies(x -> x >= 3);
    MatrixAssert
  ...
  public void testSatisfies1() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(3);
  ...
  public void testReduce() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(3);
  ...
  public void testReduceColumns() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 4).assign(3).reduceColumns(y -> y.reduce(0, Long::sum));
  ...
  public void testReduceRows() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(4, 3).assign(3).reduceRows(y -> y.reduce(0, Long::sum));
  ...
  public void testReshape() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 4, 5, 6).reshape(2, 3);
  ...
  public void testGet() throws Exception {
    LongMatrix x = LongMatrix.of(0, 1, 2, 3, 4, 5).reshape(3, 2);
  ...
  public void testSet1() throws Exception {
    LongMatrix x = LongMatrix.of(0, 1, 2, 3);
    assertEquals(0, x.get(0));
  ...
  public void testGetRowView() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 1, 2, 3, 1, 2, 3).reshape(3, 3);
  ...
  public void testGetColumnView() throws Exception {
    LongMatrix x = LongMatrix.of(1, 1, 1, 2, 2, 2, 3, 3, 3).reshape(3, 3);
  ...
  public void testGetView() throws Exception {
    LongMatrix x = LongMatrix.of(1, 1, 1, 1, 2, 2).reshape(2, 3);
    assertMatrixEquals(x.getView(0, 0, 2, 2), 1);
  }

  @Test
  public void testTranspose() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 1, 2, 3).reshape(2, 3).transpose();
  ...
  public void testCopy() throws Exception {
    LongMatrix x = LongMatrix.of(1, 1, 1, 1);
    LongMatrix y = x.copy();
    x.set(0, 1000);
  ...
  public void testNewEmptyMatrix() throws Exception {
    assertNotNull(LongMatrix.newMatrix(2, 2).newEmptyMatrix(2, 2));
  }

  @Test
  public void testNewEmptyVector() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(2, 2).newEmptyVector(2);
    assertNotNull(x);
    assertEquals(2, x.rows());
    assertEquals(1, x.columns());
  }
  ...
  public void testMmul() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 4, 5, 6).reshape(3, 2);
    LongMatrix y = LongMatrix.of(1, 2, 3, 4, 5, 6).reshape(2, 3);

    LongMatrix z = y.mmul(x);
    LongMatrix za = LongMatrix.of(22, 28, 49, 64).reshape(2, 2);
    assertMatrixEquals(za, z);

    z = x.mmul(y);
    za = LongMatrix.of(9, 12, 15, 19, 26, 33, 29, 40, 51).reshape(3, 3);
    assertMatrixEquals(za, z);
  }
  ...
  public void testMmul1() throws Exception {
    ...
    LongMatrix za = LongMatrix.of(44, 56, 98, 128).reshape(2, 2);
    assertMatrixEquals(za, z);

    z = x.mmul(4, y);
    za = LongMatrix.of(36, 48, 60, 76, 104, 132, 116, 160, 204).reshape(3, 3);
    assertMatrixEquals(za, z);
  }
  ...
  public void testMmul2() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 4, 5, 6).reshape(3, 2);
    LongMatrix y = LongMatrix.of(1, 2, 3, 4, 5, 6).reshape(3, 2);

    LongMatrix z = y.mmul(Transpose.YES, x, Transpose.NO);
    LongMatrix za = LongMatrix.of(14, 32, 32, 77).reshape(2, 2);
    assertMatrixEquals(za, z);

    z = x.mmul(Transpose.NO, y, Transpose.YES);
    za = LongMatrix.of(17, 22, 27, 22, 29, 36, 27, 36, 45).reshape(3, 3);
    assertMatrixEquals(za, z);
  }
  ...
  public void testMmul3() throws Exception {
    ...
    LongMatrix za = LongMatrix.of(28, 64, 64, 154).reshape(2, 2);
    assertMatrixEquals(za, z);

    z = x.mmul(2, Transpose.NO, y, Transpose.YES);
    za = LongMatrix.of(34, 44, 54, 44, 58, 72, 54, 72, 90).reshape(3, 3);
    assertMatrixEquals(za, z);
  }
  ...
  public void testMul1() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(3);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(2);
  ...
  public void testAdd3() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(z.getRowView(0), LongMatrix.of(4, 5, 6));
    MatrixAssert.assertValuesEquals(z.getRowView(1), LongMatrix.of(4, 5, 6));
    MatrixAssert.assertValuesEquals(z.getRowView(2), LongMatrix.of(4, 5, 6));

    z = y.add(x, Axis.COLUMN);
    MatrixAssert.assertValuesEquals(z.getColumnView(0), LongMatrix.of(4, 5, 6));
    MatrixAssert.assertValuesEquals(z.getColumnView(1), LongMatrix.of(4, 5, 6));
    MatrixAssert.assertValuesEquals(z.getColumnView(2), LongMatrix.of(4, 5, 6));
  }
  ...
  public void testDiv() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(4);
  ...
  public void testDiv2() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(6);
    LongMatrix z = y.div(x, Axis.ROW);

    MatrixAssert.assertValuesEquals(z.getRowView(0), LongMatrix.of(6, 3, 2));
    MatrixAssert.assertValuesEquals(z.getRowView(1), LongMatrix.of(6, 3, 2));
    MatrixAssert.assertValuesEquals(z.getRowView(2), LongMatrix.of(6, 3, 2));

    z = y.div(x, Axis.COLUMN);
    MatrixAssert.assertValuesEquals(z.getColumnView(0), LongMatrix.of(6, 3, 2));
    MatrixAssert.assertValuesEquals(z.getColumnView(1), LongMatrix.of(6, 3, 2));
    MatrixAssert.assertValuesEquals(z.getColumnView(2), LongMatrix.of(6, 3, 2));
  }
  ...
  public void testDiv3() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(z.getRowView(0), LongMatrix.of(12, 6, 4));
    MatrixAssert.assertValuesEquals(z.getRowView(1), LongMatrix.of(12, 6, 4));
    MatrixAssert.assertValuesEquals(z.getRowView(2), LongMatrix.of(12, 6, 4));

    z = y.div(2, x, 1, Axis.COLUMN);
    MatrixAssert.assertValuesEquals(z.getColumnView(0), LongMatrix.of(12, 6, 4));
    MatrixAssert.assertValuesEquals(z.getColumnView(1), LongMatrix.of(12, 6, 4));
    MatrixAssert.assertValuesEquals(z.getColumnView(2), LongMatrix.of(12, 6, 4));
  }

  @Test
  public void testRdiv() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(6);
  ...
  public void testRdiv1() throws Exception {
    LongMatrix x = LongMatrix.of(12, 12, 12);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(6);
  ...
  public void testRdiv2() throws Exception {
    LongMatrix x = LongMatrix.of(6, 6, 6);
    LongMatrix y = LongMatrix.newMatrix(3, 3).assign(6);
  ...
  public void testNegate() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3).assign(3).negate();
    assertMatrixEquals(x, -3);
  }

  @Test
  public void testSlice1() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 1, 2, 3).reshape(3, 2);
    LongMatrix slice = x.slice(Range.range(3));
    MatrixAssert.assertValuesEquals(slice, LongMatrix.of(1, 2, 3));
  }
  ...
  public void testSlice2() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(slice.getRowView(0), LongMatrix.of(1, 1, 1));
    MatrixAssert.assertValuesEquals(slice.getRowView(1), LongMatrix.of(2, 2, 2));
  }
  ...
  public void testSlice3() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(s.getRowView(0), LongMatrix.of(1, 1));
    MatrixAssert.assertValuesEquals(s.getRowView(1), LongMatrix.of(2, 2));
  }
  ...
  public void testSlice4() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(s, LongMatrix.of(1, 3, 3, 2));
  }
  ...
  public void testSlice5() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(s.getRowView(0), LongMatrix.of(1, 1, 1));
    MatrixAssert.assertValuesEquals(s.getRowView(1), LongMatrix.of(3, 3, 3));
  }
  ...
  public void testSlice7() throws Exception {
    ...
    MatrixAssert.assertValuesEquals(s, LongMatrix.of(1, 2, 3));
  }

  @Test
  public void testSlice() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 1, 2, 3, 1, 2, 3).reshape(3, 3);
    LongMatrix s = x.slice(BitMatrix.newBitVector(true, false, true), Axis.ROW);
    MatrixAssert.assertValuesEquals(s.getRowView(0), LongMatrix.of(1, 1, 1));
    MatrixAssert.assertValuesEquals(s.getRowView(1), LongMatrix.of(3, 3, 3));
  }
  ...
  public void testSwap() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3);
    x.swap(0, 2);
    MatrixAssert.assertValuesEquals(x, LongMatrix.of(3, 2, 1));
  }

  @Test
  public void testSetRow() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3);
    x.setRow(0, LongMatrix.of(1, 2, 3));
    MatrixAssert.assertValuesEquals(x.getRowView(0), LongMatrix.of(1, 2, 3));
  }

  @Test
  public void testSetColumn() throws Exception {
    LongMatrix x = LongMatrix.newMatrix(3, 3);
    x.setColumn(0, LongMatrix.of(1, 2, 3));
    MatrixAssert.assertValuesEquals(x.getColumnView(0), LongMatrix.of(1, 2, 3));
  }
  ...
  public void testIterator() throws Exception {
    LongMatrix x = LongMatrix.of(1, 2, 3, 4, 5, 6);
    int i = 0;
    for (long v : x) {
  ...
  public void testStream() throws Exception {
    LongMatrix m = LongMatrix.newMatrix(3, 3).assign(3);

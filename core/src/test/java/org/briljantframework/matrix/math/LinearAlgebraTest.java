...
public class LinearAlgebraTest {
  ...
  public void testLLS() throws Exception {
    DenseMatrix A =
        DenseMatrix.of(6, 5, -0.09, 0.14, -0.46, 0.68, 1.29, -1.56, 0.20, 0.29, 1.09, 0.51, -1.48,
  ...
  public void testPInv() throws Exception {
    DenseMatrix matrix = DenseMatrix.of(2, 2, 1, 2, 1, 2);
  ...
  public void testSingularValueDecomposition() throws Exception {
    DenseMatrix a = DenseMatrix.of(2, 3, 4, 2, 1, 5, 7, 10);
    SingularValueDecomposition svd = LinearAlgebra.svd(a);


    DenseMatrix original = new DenseMatrix(2, 3);
    Matrices
        .mmuli(svd.u.mmuld(svd.s), Transpose.NO, svd.v, Transpose.YES, original.asDoubleArray());
    ...
    a = DenseMatrix.of(4, 4, 0, 2, 0, 1, 2, 2, 3, 2, 4, -3, 0, 1., 6, 1, -6, -5);

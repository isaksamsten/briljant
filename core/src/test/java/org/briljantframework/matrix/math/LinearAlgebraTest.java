...
public class LinearAlgebraTest {
    ...
    public void testLLS() throws Exception {
        DenseMatrix A = DenseMatrix.of(6, 5,
...
//        System.out.println(Matrices.dmmul(DenseMatrix::new, Diagonal.of(2, 4, 1, 1), x.transpose()));
    ...
    public void testRank() throws Exception {
        DenseMatrix matrix = DenseMatrix.of(4, 4,
                0, 2, 0, 1,
                2, 2, 3, 2,
                4, -3, 0, 1.,
                6, 1, -6, -5
    ...
    public void testLu() throws Exception {
        ...
        assertArrayEquals(new double[]{
                -0.02564102564102574, 0.1794871794871794, -0.5299145299145301, 0.6410256410256412,
    ...
    public void testInverse() throws Exception {
        ...
        DenseMatrix a = DenseMatrix.of(2, 2,
                1, 1,
                1, 2
        );
    ...
    public void testPInv() throws Exception {
        DenseMatrix matrix = DenseMatrix.of(2, 2,
                1, 2,
                1, 2
        );
        ...
        DenseMatrix am = DenseMatrix.of(4, 4, A);
        inverse = pinv(am);
    ...
    public void testSingularValueDecomposition() throws Exception {
        DenseMatrix a = DenseMatrix.of(2, 3,
                4, 2, 1,
                5, 7, 10
        );
        ...
        assertArrayEquals(new double[]{
                ...
                0.24529511499304546, -0.41218392058260367, -0.4368411256519435, 0.19953957134805714, 0.9659025051231179,

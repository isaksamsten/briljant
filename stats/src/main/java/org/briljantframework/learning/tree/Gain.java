...
public class Gain {
    ...
    public double calculate(double leftWeight, double[] left, double rightWeight, double[] right, double[] leftRight) {
    ...
    public double calculate(double leftWeight, double rightWeight, double[] leftRelativeFrequencies,
        ...
        return (leftWeight * impurity.impurity(leftRelativeFrequencies)) + (rightWeight * impurity.impurity
                (rightRelativeFrequencies));
    }

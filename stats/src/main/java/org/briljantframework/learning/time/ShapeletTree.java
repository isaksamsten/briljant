...
public class ShapeletTree implements Classifier {
    ...
    public static class Model extends Tree.Model<ShapeletThreshold> {
         ...
         */
        protected Model(Node<ShapeletThreshold> node, ShapletTreeVisitor predictionVisitor, DenseMatrix lengthImportance, DenseMatrix positionImportance, double totalErrorReduction) {

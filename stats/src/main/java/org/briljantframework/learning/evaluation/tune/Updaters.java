...
public final class Updaters {
     ...
     * @return the updater
     */
    public static <T> Updater<T> range(String name, Updater.Update<? super T, Integer> consumer, int start, int end, int step) {
     ...
     * @return the updater
     */
    public static <T> Updater<T> range(String name, Updater.Update<? super T, Double> consumer, double start, double end, double step) {
        return new Updater<T>() {
     ...
     */
    @SafeVarargs
    public static <T, V> Updater<T> enumeration(String name, Updater.Update<T, V> updater, V... enumeration) {

...
//
//
//        Configurations<KNearestNeighbors> configurations = Tuners.crossValidation(ClassificationFrame.FACTORY,
...
//                correct += 1;
//            } else {
//                System.out.printf("%s for %s (real %s)%n", p.getProbability(), p.getValue(), testTarget.getValue(i));
//            }
//        }

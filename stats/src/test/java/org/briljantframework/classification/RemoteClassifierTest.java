...
public class RemoteClassifierTest {
  ...
  public void testDataset() throws Exception {
    // DataFrameInputStream in = new CSVInputStream(new
  ...
  public void testRandomForest() throws Exception {
    ...
    // DataFrameInputStream in = new CSVInputStream(new
    // FileInputStream("erlang/adeb-rr/deps/rr/data/anneal-orig.txt"));
    // DenseDataFrame dataset = in.read(DenseDataFrame.copyTo());
    //
    // SupervisedDataset<DenseDataFrame, CategoricColumn> supervisedDataset =
    // SupervisedDataset.createClassificationInput(dataset, DenseDataFrame.copyTo(),
    // DefaultCategoricColumn.copyTo());
    //
    // ClassificationForest forest =
    // ClassificationForest.withSize(100).withMaximumFeatures(4).create();
    ...
    // System.out.println(
    // Tuners.crossValidation(forestBuilder, supervisedDataset,
